...
#define leftForward(speed) LeftForward();RightForward();analogWrite(PWMLeft,speed-30);analogWrite(PWMRight,speed)
#define rightForward(speed) LeftForward();RightForward();analogWrite(PWMRight,speed-30);analogWrite(PWMLeft,speed)
